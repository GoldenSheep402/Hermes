...
async function handleSubmit({ errors, values }: {
  ...
  <div class="login-form-wrapper">
    ...
    <a-form :model="loginForm" class="login-form" layout="vertical" @submit="handleSubmit">
      <a-form-item
        ...
        ]" :validate-trigger="['change', 'blur']" feedback hide-label
      >
      ...
      <a-form-item
        field="password" :rules="[{ required: true, message: $t('login.form.password.required') }]"
