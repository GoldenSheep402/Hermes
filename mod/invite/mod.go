...
import (
	...
	"github.com/GoldenSheep402/Hermes/mod/invite/service"
...
func (m *Mod) Load(h *kernel.Hub) error {
	...
	inviteV1.RegisterInviteServiceServer(&GRPC, &service.S{
		Log: h.Log.Named("invite.service"),
	})
	if err := gw.Register(inviteV1.RegisterInviteServiceHandler); err != nil {
