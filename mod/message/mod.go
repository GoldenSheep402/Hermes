...
import (
	...
	"github.com/GoldenSheep402/Hermes/mod/message/service"
...
func (m *Mod) Load(h *kernel.Hub) error {
	...
	messageV1.RegisterMessageServiceServer(&GRPC, &service.S{
		Log: h.Log.Named("message.service"),
	})
	if err := gw.Register(messageV1.RegisterMessageServiceHandler); err != nil {
