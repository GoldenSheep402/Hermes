...
type TransferHistory struct {
	stdao.Model
	UserID     string    `gorm:"type:char(26);index;uniqueIndex:uidx_transfer_history_user_torrent,priority:1;not null" json:"user_id"`
	TorrentID  string    `gorm:"type:char(26);index;uniqueIndex:uidx_transfer_history_user_torrent,priority:2;not null" json:"torrent_id"`
